...
const Hero = () => {
  return (
    <section className='max-w-[1240px] mx-auto px-[1rem] py-[1rem] flex justify-between items-center max-md:flex-col'>
        <div className="w-[55%] max-md:w-full flex flex-col gap-[1.5rem]">
